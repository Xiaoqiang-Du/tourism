    ...
    var obj = {
        ...
        sliderMove: function (dir) {
            ...
            if (!this.lock) {
                // return false;
                this.lock = true;
                // console.log( $(this.father).find('#swiperUl').offset())
                if (dir == 'pre') {
                    if (this.nowIndex == 0) {
                    ...
                    self.nowIndex ++;
                    console.log( $(this.father).find('#swiperUl').css('left'))
                    $(this.father).find('#swiperUl').animate({
                    ...
                    console.log(self.nowIndex, self.imgNum, dir)
                    ...
                    $(this.father).find('#swiperUl').animate({
                        ...
                        console.log('---', $(self.father).find('#swiperUl'))
                        if (self.nowIndex == self.imgNum) {
                            $(self.father).find('#swiperUl').css('left', '0px');
                            self.nowIndex = 0;
                        }
